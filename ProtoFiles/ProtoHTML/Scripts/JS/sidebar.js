...
document.addEventListener('DOMContentLoaded', () => {
    ...
    setTimeout(() => {
        if (loader.style.visibility == 'visible')
            ID('errormessage').classList.remove('magic');
    }, 20000);
});
...
function helptext1(ioBool, buttonType) {
...
async function getSpells(bool = false) {
    ...
    if (ID('spellcast').classList.contains('grayout'))
        ID('spellcast').classList.remove('grayout');
    loader.classList.add('magic');
...
function setSlots() {
    const obj = {
        sc1: { dis: (Number(ID('cursc1').value) > 0 || ID('cursc1').dataset.ignore == "false") ? true : false, val: Number(ID('cursc1').value) },
        sc2: { dis: (Number(ID('cursc2').value) > 0 || ID('cursc2').dataset.ignore == "false") ? true : false, val: Number(ID('cursc2').value) },
        sc3: { dis: (Number(ID('cursc3').value) > 0 || ID('cursc3').dataset.ignore == "false") ? true : false, val: Number(ID('cursc3').value) },
        sc4: { dis: (Number(ID('cursc4').value) > 0 || ID('cursc4').dataset.ignore == "false") ? true : false, val: Number(ID('cursc4').value) },
        sc5: { dis: (Number(ID('cursc5').value) > 0 || ID('cursc5').dataset.ignore == "false") ? true : false, val: Number(ID('cursc5').value) },
        sc6: { dis: (Number(ID('cursc6').value) > 0 || ID('cursc6').dataset.ignore == "false") ? true : false, val: Number(ID('cursc6').value) },
        sc7: { dis: (Number(ID('cursc7').value) > 0 || ID('cursc7').dataset.ignore == "false") ? true : false, val: Number(ID('cursc7').value) },
        sc8: { dis: (Number(ID('cursc8').value) > 0 || ID('cursc8').dataset.ignore == "false") ? true : false, val: Number(ID('cursc8').value) },
        sc9: { dis: (Number(ID('cursc9').value) > 0 || ID('cursc9').dataset.ignore == "false") ? true : false, val: Number(ID('cursc9').value) },
        pm1: { dis: (Number(ID('curpm1').value) > 0 || ID('curpm1').dataset.ignore == "false") ? true : false, val: Number(ID('curpm1').value) },
        pm2: { dis: (Number(ID('curpm2').value) > 0 || ID('curpm2').dataset.ignore == "false") ? true : false, val: Number(ID('curpm2').value) },
        pm3: { dis: (Number(ID('curpm3').value) > 0 || ID('curpm3').dataset.ignore == "false") ? true : false, val: Number(ID('curpm3').value) },
        pm4: { dis: (Number(ID('curpm4').value) > 0 || ID('curpm4').dataset.ignore == "false") ? true : false, val: Number(ID('curpm4').value) },
        pm5: { dis: (Number(ID('curpm5').value) > 0 || ID('curpm5').dataset.ignore == "false") ? true : false, val: Number(ID('curpm5').value) },
        pm6: { dis: (Number(ID('curpm6').value) > 0 || ID('curpm6').dataset.ignore == "false") ? true : false, val: Number(ID('curpm6').value) },
        pm7: { dis: (Number(ID('curpm7').value) > 0 || ID('curpm7').dataset.ignore == "false") ? true : false, val: Number(ID('curpm7').value) },
        pm8: { dis: (Number(ID('curpm8').value) > 0 || ID('curpm8').dataset.ignore == "false") ? true : false, val: Number(ID('curpm8').value) },
        pm9: { dis: (Number(ID('curpm9').value) > 0 || ID('curpm9').dataset.ignore == "false") ? true : false, val: Number(ID('curpm9').value) }
    };
