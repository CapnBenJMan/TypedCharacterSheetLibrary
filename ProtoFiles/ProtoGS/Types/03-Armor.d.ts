...
declare function armorSetter(selection: ArmorSelection, armor: string, stat: string, natStat: string, shield: boolean, bonuses: ArmorBonuses, notes: ArmorNotes, custom: CustomArmor): void;
