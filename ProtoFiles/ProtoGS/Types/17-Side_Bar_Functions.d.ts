 ...
 */
declare function getOuterRange(currentCell: GoogleAppsScript.Spreadsheet.Range, ss: GoogleAppsScript.Spreadsheet.Spreadsheet, sheetName: string): string;
/** Checks if the range subRange intersects in any way with searchRange */
declare function isWithinRange(subRange: GoogleAppsScript.Spreadsheet.Range, ...searchRange: GoogleAppsScript.Spreadsheet.Range[]): {
    tf: boolean;
    row: number;
    col: number;
};
