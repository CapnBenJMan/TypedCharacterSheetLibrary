...
declare function getClassInfo(): {
    ...
    readonly arr: readonly ["edit", number, {
        class: any;
        subclass: any;
        level: any;
        hitdie: any;
...
declare function addEditInfo(className: string, subclass: string, level: number | string, hitdie: number | string, spells: string, x: number, selection?: string): void;
