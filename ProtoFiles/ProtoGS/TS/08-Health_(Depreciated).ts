/** @deprecated */
function healthDepreciated(e: GoogleAppsScript.Events.SheetsOnEdit) {
	...
	function modHealth(h: number | string) { //updates current health value and healthbar value
		healthP.setValue(h)
		barHealth.setValue(h)
	}

	function modTemp(t: any) { //updates tempHP value
		tempP.setValue(t)
	}
}